...
// Klasa Ponieżej możemy znaleźć wszystkie
// atrybuty zamówień (ID,Nazwe,date,status). Sam konstruktor Product użyty jest w Widoku
// Podobnie jak sam Builder na dole ma za zadanie już tworzyć za pomocą wyobrażenia wzorców
// konstrukcyjnych nasze produkty.
// Funkcja calculateRating pozwala nam obliczyć aktualną cenę po dodaniu naszych produktów do koszyka.
    private int id;
    private String name;
